...
```
$ git clone https://github.com/khulnasoft/flask-boilerplate.git
...
* `ADMIN_EMAIL`: set to the default email for your first admin account (default is `flask-boilerplate-admin@example.com`)
